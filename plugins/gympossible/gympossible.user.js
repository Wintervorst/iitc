...
// @description    [iitc-20181109.010107] Highlights level 14 cells where the next stop wil generate a gym in that cell in order to see where you would best submit new portal candidates
...
//(leaving them in place might break the 'About IITC' page or break update checks)
  ...
  window.plugin.gympossible.cellOptionsOccupied = {fill: true, color: 'teal', fillColor:'teal', opacity: 1, weight: 6, fillOpacity:0.30, clickable: false };
  window.plugin.gympossible.cellOptionsEmpty = {fill: false, color: 'pink', opacity: 0.5, weight: 6, clickable: false };
