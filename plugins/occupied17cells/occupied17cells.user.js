...
//(leaving them in place might break the 'About IITC' page or break update checks)
  ...
  window.plugin.occupied17cells.cellOptionsOccupied = {fill: true, color: 'blue', fillColor:'blue', opacity: 1, weight: 4, fillOpacity:0.30, clickable: false };
  window.plugin.occupied17cells.cellOptionsEmpty = {fill: false, color: 'orange', opacity: 0.5, weight: 4, clickable: false };
